...
<div class="mb-2 border-solid border-grey-light rounded border shadow-sm w-full md:w-1/2 lg:w-1/2">
    ...
    <div class="p-5">
        ...
        <form action="{{route('UpdateCountry',$editPu->id)}}" method="POST" class="w-full bg-gray-300">
            @csrf
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-3/4">
                    <input class="bg-grey-200 appearance-none border-1 border-grey-200 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-purple-light"
                           name="pu_country" type="text" value="{{$editPu->pu_country}}" >
                </div>
            </div>
            <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/4">
                ...
                <div class="md:w-3/4">
                    <input class="bg-grey-200 appearance-none border-1 border-grey-200 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-purple-light"
                           name="pu_total_all" type="number" value="{{$editPu->pu_total_all}}" >
                </div>
                ...
                <div class="md:w-3/4">
                    <input class="bg-grey-200 appearance-none border-1 border-grey-200 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-purple-light"
                           name="pu_density" type="number" step="0.01" value="{{$editPu->pu_density}}" >
                </div>
            </div><div class="md:flex md:items-center mb-6">
                <div class="md:w-1/4">
                    <label class="block text-gray font-regular md:text-right mb-1 md:mb-0 pr-4"
                ...
                <div class="md:w-3/4">
                    <input class="bg-grey-200 appearance-none border-1 border-grey-200 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:outline-none focus:bg-white focus:border-purple-light"
                           name="pu_median_age" type="number" step="0.01" value="{{$editPu->pu_median_age}}" >
                </div>
            </div>
